...
class Borrow extends Component{
    ...
    get_select(){
        ...
        axios_loanMgnt.post("/manage/util/getLoanAppOptions",{labelType:"BUSINESS",labelName:"自有资金业务",usage:"CONTRACT_LIST"}).then(e=>{
            if(!e.code){
                var domain=[];
                for(var i in e.data){
        ...
        axios_loanMgnt.post("/manage/util/getProductOptions",{labelType:"BUSINESS",labelName:"自有资金业务",usage:"CONTRACT_LIST"}).then(e=>{
            if(!e.code){
                var appKey=[];
                for(var i in e.data){
    ...
    detail(data){
        window.open('/jk/list/zyzj/detail?borrowerId='+data.borrowerId+"&contract_no="+data.contractNo+"&contractId="+data.contractId+"&labelName=自有资金业务&domainNo="+data.domainNo);
    }
