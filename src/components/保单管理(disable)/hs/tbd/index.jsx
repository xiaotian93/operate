...
import {company_list,product_list,get_merchant_list,tbd_list_hs,patch_bd_prepare,patch_bd,deny_archive} from '../../../../ajax/api';
...
export default ComponentRoute(Form.create()(Borrow));
