...
import {Row,Col,Form,Input,message,Button,Modal} from 'antd';
...
class Tb extends Component{
    ...
    sure(){
        browserHistory.push("/zj/business");
    }
    render() {
        ...
        const tb_modal={
            ...
            closable:false,
            footer:[
                <Button type="primary" onClick={this.cancel.bind(this)}>暂不认领</Button>,
                <Button type="primary" onClick={this.sure.bind(this)}>去认领</Button>  
            ],
            visible:this.state.tb
        }
        return(
            <Row>
                <Row>
                ...
                <Modal {...tb_modal}><span style={{fontSize:"14px"}}>是否直接去认领退保流水？</span></Modal>
            </Row>
        )
    }
}
