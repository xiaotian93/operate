...
import { capital_account_detail_info } from '../../../../../ajax/api';
...
class Product_cxfq extends Component {
    ...
    sure() {
        bmd.redirect("/zj/account/edit?accountId="+this.state.accountId)
    }
    CountOnref(e) {
        this.count = e
    }
            ...
            <div>
                <Form className="product_cxfq sh_add content" >
                    ...
                    <Row style={{ height: "50px", background: "#fff", position: "fixed", bottom: "0", right: "0", lineHeight: "50px", textAlign: "center", width: "calc(100% - 170px)", boxShadow: "0px -2px 4px 0px rgba(0,0,0,0.1)" }}>
                        ...
                        <Permissions server={global.AUTHSERVER.account.key} permissions={global.AUTHSERVER.account.access.balance_edit} tag="button" key="edit" type="primary" style={{ marginLeft: '30px' }} onClick={this.sure.bind(this)}>编辑</Permissions>
                    </Row>
                </Form>
