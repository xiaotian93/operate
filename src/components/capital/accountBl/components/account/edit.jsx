...
import { capital_bl_account_detail_info, capital_bl_account_edit_info } from '../../../../../ajax/api';
...
class Product_cxfq extends Component {
    ...
    //cancel
    cancel() {
        browserHistory.push('/zj/blaccount');
    }
    getValue(name, val) {
    ...
    sure() {
        ...
        // return;
        axios_zj.post(capital_bl_account_edit_info, param).then(e => {
            if (!e.code) {
                this.setState({
                    leave: false,
                    isleave: true
