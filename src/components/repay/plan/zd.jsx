...
const Bl = () => {
    ...
    let listProps = {
        ...
        bindcolumns:(columns,templates)=>{
            ...
            operateCol.operate = data=>{
                ...
                //     btn.push(<Button size="small" type="primary" onClick={() => { repayShow(data) }} key={data.domainNo+"repay_gyl"}>还款全部</Button>)
                // }
    ...
    return <RepayListTemplate {...listProps} >
                <Repay onRef={model => instance.repayAllModel = model} repayAll project={listProps.project} repayType="助贷业务" />
    </RepayListTemplate>
}
