...
// import {format_time,accDiv} from '../../../ajax/tool';
            ...
            },
            {
                ...
                render:e=>{
                    ...
                    if (this.state.repayBtn==="true"&&(e.repayPlanStatus === 100 || e.repayPlanStatus === 110)){
                        if(this.state.appKey==="gongyinglian"){
                            btn.push(<Button size="small" type="primary" onClick={() => { this.repayShow(e) }}>确认还款</Button>)
                        }else{
                            btn.push(<Permissions size="small" type="primary" server={global.AUTHSERVER.ygd.key} permissions={this.state.appKey==="yuangongdai"?global.AUTHSERVER.ygd.access.ygd_repay:global.AUTHSERVER.ygd.access.jyd_repay} tag="button" onClick={() => { this.repayShow(e) }}>确认还款</Permissions>)
                        }
                    }
...
render() {
        ...
        const repayType={gongyinglian:"供应链金融",yuangongdai:"员工贷",jingyingdai:"员工贷"};
        return (
            <div className="content" style={{ marginBottom: "30px" }}>
                ...
                <Repay onRef={this.repay.bind(this)} domainNo={this.state.contract.domainNo} repayPhase={this.state.repayPhase} project={this.state.title} contract_no={this.state.contract_no} repayType={repayType[this.state.appKey]} />
                {/* <Modal {...fee}> */}
